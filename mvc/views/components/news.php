<div style="margin-top:70px" class="li-main-blog-page pt-60 pb-55">
                <div class="container">
                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="li-blog-banner">
                                                    <a href=""><img style="max-height:200px;max-width:200px" class="img-full" src="https://image.cellphones.com.vn/358x/media/catalog/product/v/s/vsmart-star-5-3_3.jpg" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">
                                    <div class="li-blog-single-item pb-30">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="li-blog-banner">
                                                    <a href=""><img style="max-height:200px;max-width:200px" class="img-full" src="https://image.cellphones.com.vn/358x/media/catalog/product/v/s/vsmart-joy-4_1__2.png" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="li-blog-content">
                                ...
                                <div class="col-lg-12">
                                    <div class="li-blog-single-item mb-30">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="li-blog-banner">
                                                    <a href=""><img style="max-height:200px;max-width:200px" class="img-full" src="https://image.cellphones.com.vn/358x/media/catalog/product/i/p/iphone_13-_pro-5_4.jpg" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="li-blog-content">
