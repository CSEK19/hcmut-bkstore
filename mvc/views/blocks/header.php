    ...
    <body>
            ...
            <nav id="navColor" class=" navbar fixed-top navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item <?php if($data["render"]!="tintuc" && $data["render"]!="gioithieu" && $data["render"]!="contact") echo "active"; ?>">
                            <a class="nav-link" href="http://localhost/bkstore/Home">Trang chủ <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <a class="dropdown-item" href="http://localhost/bkstore/Home/productList/0">Tất cả</a>
                            <?php
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php if($data["render"]=="tintuc") echo "active"; ?>" href="http://localhost/bkstore/Home/tintuc">Tin tức</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if($data["render"]=="gioithieu") echo "active"; ?>" href="http://localhost/bkstore/Home/gioithieu">Giới thiệu</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if($data["render"]=="contact") echo "active"; ?>" href="http://localhost/bkstore/Home/contact">Liên hệ</a>
                        </li>
                    </ul>
                ...
                <div style="margin-right: 20px;" class="nav-item dropdown">
                    ...
                    <?php
                        if(!isset($fullname)){
                            echo '<a class="dropdown-item" href="http://localhost/bkstore/Login">Đăng nhập</a>';
                            echo '<a class="dropdown-item" href="http://localhost/bkstore/Register">Đăng ký</a>';
                        }
                        else{
                            if($user["role_id"] == 2) echo '<a class="dropdown-item" href="http://localhost/bkstore/Admin">Quản lý trang web</a>';
                            echo '<a class="dropdown-item" href="http://localhost/bkstore/Home/quanlytaikhoan">Quản lý tài khoản</a>';
                            echo '<a class="dropdown-item" href="http://localhost/bkstore/Home/quanlydonhang/'.$user["id"].'">Quản lý đơn hàng</a>';
                            echo '<a class="dropdown-item" href="http://localhost/bkstore/Login/UserLogout">Đăng xuất</a>';
                        } 
